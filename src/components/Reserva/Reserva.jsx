...
const Reserva = () => {
  ...
  return (
    <div className="reserva-container">
      <h1>Reserva y Pagos</h1>

      {/* Paquetes */}
      <div className="section">
        <h2>Paquetes de Fotos</h2>
        <div className="horizontal-scroll">
          {paquetes.map((paquete) => (
            <div key={paquete.id} className="option-card">
              <label>
                <input
                  type="radio"
                  name="paquete"
      ...
      <div className="section">
        ...
        <div className="grid-layout">
          {limosinas.map((limosina) => (
            <div key={limosina.id_limosina} className="option-card">
              <label>
                <input
                  type="radio"
                  name="limosina"
                ...
                />
                {limosina.modelo} -  ${limosina.precio_por_hora}
              </label>
              <img
      ...
      <div className="section">
        ...
        <div className="grid-layout">
          {locales.map((local) => (
            <div key={local.id} className="option-card">
              <label>
                <input
                  type="radio"
                  name="local"
                ...
                />
                {local.nombre_local} - ${local.precio_por_hora}
              </label>
              <img
          ...
          <form onSubmit={handleSubmitPago}>
            ...
            <div className="form-control">
              ...
              >
                ...
                <option value="4">Confirm1ada</option>
